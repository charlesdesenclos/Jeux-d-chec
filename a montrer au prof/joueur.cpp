...
bool JoueurC::ia_selectionPionAJouer(TableJeu &table_jeu)
{
	...
	{
		if (table_jeu.joueurs.at(0).pions.at(compt).type_pion == pion_N)
		{
			bool m_gauche = false;
			bool m_droite = false;
		...
		if (table_jeu.joueurs.at(0).pions.at(compt).type_pion == pion_N_D)
		{
			bool m_haut_g = false;
			bool m_haut_d = false;
			bool m_bas_g = false;
	...
	if (!poss_deplacem_simple)
	{
		...
		{
			if (table_jeu.joueurs.at(0).pions.at(compt2).type_pion == pion_N)
			{
				bool m_g = false;
				bool m_d = false;
			...
			if (table_jeu.joueurs.at(0).pions.at(compt2).type_pion == pion_N_D)
			{
				bool m_haut_g = false;
				bool m_haut_d = false;
				bool m_bas_g = false;
...
void JoueurC::CPU_Tour(TableJeu &table_jeu)
{
	...
	if (ia_selectionPionAJouer(table_jeu))
	{
		...
		{
			if (table_jeu.joueurs.at(0).pions.at(cmpt).selectionne == true && table_jeu.joueurs.at(0).pions.at(cmpt).type_pion == pion_N)
			{
				pion_type = 0;
			}

			if (table_jeu.joueurs.at(0).pions.at(cmpt).selectionne == true && table_jeu.joueurs.at(0).pions.at(cmpt).type_pion == pion_N_D)
			{
				pion_type = 2;
			}
			cmpt++;
				...
				if (ia_simp_depl)
				{
					...
					while (compt < table_jeu.joueurs.at(0).pions.size())
					{
						if (table_jeu.joueurs.at(0).pions.at(compt).selectionne)
						{
							...
							//
							if (!dir_b_g && posInitPX > 0 && posInitPY < 9)
							{
								dir_b_g = true;
								int posX = posInitPX - 1;
								int posY = posInitPY + 1;
							...
							if (!dir_b_d && posInitPX < 9 && posInitPY < 9)
							{
								dir_b_d = true;
								int posX = posInitPX + 1;
								int posY = posInitPY + 1;
							...
							if (!dir_h_d && posInitPX < 9 && posInitPY > 0)
							{
								dir_h_d = true;
								int posX = posInitPX - 1;
								int posY = posInitPY + 1;
...
bool JoueurC::JeuPossibleDame(TableJeu &table_jeu)
{
	...
	while (cmpt < table_jeu.joueurs.at(1).pions.size())
	{
		if (table_jeu.joueurs.at(1).pions.at(cmpt).selectionne == true)
		{
			...
			if (!poss_cap)
			{
				if (espace_vide && ((sourisX / 75 == indic_pos_x - 1 && sourisY / 75 == indic_pos_y - 1) || (sourisX / 75 == indic_pos_x + 1 && sourisY / 75 == indic_pos_y - 1 && sourisX / 75 < 8) || (sourisX / 75 == indic_pos_x - 1 && sourisY / 75 == indic_pos_y + 1) || (sourisX / 75 == indic_pos_x + 1 && sourisY / 75 == indic_pos_y + 1 && sourisX / 75 < 8)))
				{
					possible = true;
				}
			}
...
bool JoueurC::ia_PossibiliteCapture(TableJeu &table_jeu)
{
	...
	while (compt < table_jeu.joueurs.size())
	{
		...
		while (compt2 < table_jeu.joueurs.at(compt).pions.size())
		{
			...
			if (table_jeu.joueurs.at(compt).pions.at(compt2).type_pion == pion_N)
			{
				if (table_jeu.joueurs.at(compt).pions.at(compt2).selectionne == true)
				{
					tableau_virtuel[posx][posy] = 1;
			...
			if (table_jeu.joueurs.at(compt).pions.at(compt2).type_pion == pion_N_D)
			{
				if (table_jeu.joueurs.at(compt).pions.at(compt2).selectionne == true)
				{
					tableau_virtuel[posx][posy] = 1;
...
void JoueurC::PromotionPion(TableJeu &table_jeu)
{
	...
	while (compt < table_jeu.joueurs.size())
	{
		...
		while (compt2 < table_jeu.joueurs.at(compt).pions.size())
		{
			...
			if (table_jeu.joueurs.at(compt).pions.at(compt2).type_pion == pion_N)
			{
				if (table_jeu.joueurs.at(compt).pions.at(compt2).s_pion.getPosition().y == 712.5)
				{
					table_jeu.joueurs.at(compt).pions.at(compt2).type_pion = pion_N_D;
				}
			}
